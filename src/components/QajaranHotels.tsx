...
const qajaranHotels: Hotel[] = [
    ...
    },
    {
        ...
        rating: 8.8,
        reviews: 94,
        address: "12 Khanjyan St, Qajaran, Armenia",
        highlights: ["Modern rooms", "Mountain peak views", "Free Wi-Fi", "Traditional breakfast"],
        priceRange: "~$50–$80 / night",
        phone: "+374 286 3-45-67",
        url: "https://www.booking.com/searchresults.html?ss=Kapan",
    },
    {
        name: "Lichk Eco Guesthouse",
        stars: 4,
        rating: 9.3,
        reviews: 76,
        address: "Lichk Village (near Qajaran), Syunik, Armenia",
        highlights: ["Eco-friendly stay", "Waterfall trails", "Organic farm-to-table", "Garden patio"],
        priceRange: "~$40–$70 / night",
        phone: "+374 286 3-88-99",
        url: "https://www.booking.com/searchresults.html?ss=Kapan",
    },
    {
        name: "Voghji Riverside Inn",
        stars: 4,
        rating: 8.7,
        reviews: 64,
        address: "Voghji Riverbank, Qajaran, Armenia",
        highlights: ["Riverside terrace", "Barbecue facilities", "Cozy lounge", "Free parking"],
        priceRange: "~$45–$75 / night",
        phone: "+374 286 3-11-22",
        url: "https://www.booking.com/searchresults.html?ss=Kapan",
    },
    {
        name: "Basalt Peaks Lodge",
        stars: 4,
        rating: 9.0,
        reviews: 82,
        address: "Near Bear Monument, Qajaran, Armenia",
        highlights: ["Close to city park", "Guided mountain tours", "Hot tubs", "Local wines"],
        priceRange: "~$60–$100 / night",
        phone: "+374 286 3-99-00",
        url: "https://www.booking.com/searchresults.html?ss=Kapan",
    },
];
...
export default function QajaranHotels() {

    /**
     * 
     * QajaranHotels Component:
     *  
     */
            ...
            <div className="max-w-7xl mx-auto space-y-14">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-black uppercase text-zinc-900 dark:text-white">
                        Top <span className="text-orange-500">5 Hotels</span> in Qajaran
                    </h2>
                    <p className="text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto text-lg">
                        Handpicked accommodations with 4+ stars — comfort, mountain views, and warm Syunik hospitality.
                    </p>
                </motion.div>

                <div className="grid gap-6 md:gap-8">
                    {qajaranHotels.map((hotel, index) => (
                        <motion.div
                            key={hotel.name}
