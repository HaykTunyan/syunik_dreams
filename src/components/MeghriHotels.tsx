...
const meghriHotels: Hotel[] = [
    ...
    },
    {
        ...
        rating: 9.4,
        reviews: 98,
        address: "Old District, Meghri, Armenia",
        highlights: ["Historic architectural home", "Stone terrace & garden", "Authentic breakfast", "Cultural tours"],
        priceRange: "~$60–$95 / night",
        phone: "+374 286 4-10-15",
        url: "https://www.booking.com/searchresults.html?ss=Meghri",
    },
    {
        name: "Vardanants Hotel Meghri",
        stars: 4,
        rating: 8.9,
        reviews: 112,
        address: "Vardanants St, Meghri, Syunik, Armenia",
        highlights: ["Central location", "Cozy lounge", "Free parking", "Mountain panorama"],
        priceRange: "~$45–$75 / night",
        phone: "+374 286 4-22-44",
        url: "https://www.booking.com/searchresults.html?ss=Meghri",
    },
    {
        name: "Narema Family Hotel",
        stars: 4,
        rating: 8.8,
        reviews: 86,
        address: "Near Meghri River, Meghri, Armenia",
        highlights: ["Riverside views", "Home-style dining", "Garden terrace", "Free Wi-Fi"],
        priceRange: "~$40–$65 / night",
        phone: "+374 286 4-55-66",
        url: "https://www.booking.com/searchresults.html?ss=Meghri",
    },
    {
        name: "Gam Guest House",
        stars: 4,
        rating: 9.1,
        reviews: 73,
        address: "Near Old Bridge, Meghri, Armenia",
        highlights: ["Lush garden orchard", "Personalized service", "Barbecue facilities", "Local fruit tasting"],
        priceRange: "~$35–$60 / night",
        phone: "+374 286 4-77-88",
        url: "https://www.booking.com/searchresults.html?ss=Meghri",
    },
];
...
export default function MeghriHotels() {

    /**
     * 
     * MeghriHotels Component:
     * This component displays the top 5 hotels in Meghri, Armenia.
     * 
     */
            ...
            <div className="max-w-7xl mx-auto space-y-14">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-black uppercase text-zinc-900 dark:text-white">
                        Top <span className="text-orange-500">5 Hotels</span> in Meghri
                    </h2>
                    <p className="text-zinc-500 dark:text-zinc-400 max-w-xl mx-auto text-lg">
                        Handpicked accommodations with 4+ stars — comfort, lush gardens, and warm Syunik hospitality.
                    </p>
                </motion.div>

                <div className="grid gap-6 md:gap-8">
                    {meghriHotels.map((hotel, index) => (
                        <motion.div
                            key={hotel.name}
