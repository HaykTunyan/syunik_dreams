...
export const translations = {
  ...
  hy: {
    ...
    'trips.old_khndzoresk_desc': 'Հնագույն քարանձավային գյուղ, որը փորվել է ժայռերի մեջ և լքվել է 1950-ական թվականներին — ձորի զարմանահրաշ ուրվականների քաղաք:',
    'trips.khndzoresk_caves': 'Խնձորեսկի քարանձավներ',
    'trips.khndzoresk_caves_desc': 'Հարյուրավոր բնական և արհեստական քարանձավներ, որոնք դարեր շարունակ ծառայել են որպես բնակատեղ՝ կապված հայտնի ճոճվող կամրջով:',
