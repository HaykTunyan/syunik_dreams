...
export default function CityStatsCard({ label, value, icon }: { label: string; value: string; icon: string }) {
    ...
    return (
        <div className="bg-white dark:bg-zinc-900 p-6 md:p-8 rounded-4xl shadow-xl border border-zinc-100 dark:border-zinc-800 group hover:border-orange-500 transition-all duration-300">
